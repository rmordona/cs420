...
On the other hand, we don't have to measure the interaction between Color and BoilGravity, or  Color and BoilTime as determined by model 1 because those interactions do not prove to be significant in model 3.
